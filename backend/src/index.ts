...
import { establishConnection, cleanup } from "./services/tunnel.js";
...
const server = app.listen(config.port, async () => {
  console.log(`[server] PersonalCloud backend running on port ${config.port}`);
